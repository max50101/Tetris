...
import com.bignerdranch.android.tetris.AppModel
...
class TetrisView: View {
    ...
    fun setGameCommandWithDelay(move: AppModel.Motions) {val now = System.currentTimeMillis()
    ...
    //Класс для обработки сообщений для генерации блоков
